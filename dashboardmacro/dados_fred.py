...
FRED_INDICATORS = [
    ...
    {"id": "PPIFIS", "key": "ppi_mom", "indicador": "PPI - Var. % mensal", "descricao": "PPI (PPIFIS) variacao percentual mensal (MoM)", "frequencia": "mensal", "grupo": "Inflacao", "unidade": "%", "tipo_grafico": "linhas", "units": "pch"},
    {"id": "PPIFIS", "key": "ppi_12m", "indicador": "PPI - Var. % 12m", "descricao": "PPI (PPIFIS) variacao percentual em 12 meses (YoY)", "frequencia": "mensal", "grupo": "Inflacao", "unidade": "%", "tipo_grafico": "linhas", "units": "pc1"},
